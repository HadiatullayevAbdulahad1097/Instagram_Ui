...
import developer.abdulahad.instagram_ui.adapter.ActualAdapter
import developer.abdulahad.instagram_ui.adapter.PostAdapter
import developer.abdulahad.instagram_ui.adapter.User3
import developer.abdulahad.instagram_ui.adapter.UserPost
...
class BlankFragment3 : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.nopublicImage.visibility = View.INVISIBLE
        ...
        binding.postlarVidyoCard.setOnClickListener {
            ...
            binding.nopublicImage.visibility = View.VISIBLE
